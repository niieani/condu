...
const FileDefPartial = t.partial({
  ...
  type: t.unionOfStrings("ephemeral", "publish", "commit"),
  content: t.string,
});
const FileDefValidator = t.intersection([
  FileDefPartial,
  t.type({
    path: t.string,
  }),
...
export const configure = (config: RepoConfig): RepoConfig => config;
